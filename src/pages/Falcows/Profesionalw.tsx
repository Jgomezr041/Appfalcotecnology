...
import './falcocr.css';
import Profesional from '../../components/falcocr/Profesionall';
import userImage from '../../../public/Falcows/logoft.png';

const nombre = 'Admin';
const ocupacion = 'no especificado';

const  Profesionalw: React.FC = () => {
      ...
      <IonPage id="main-content">
        <IonHeader>
          <IonToolbar color="primary">
            ...
            <IonTitle>Servicio de profesional</IonTitle>
          </IonToolbar>
        </IonHeader>
        <IonContent>
            <Profesional />
